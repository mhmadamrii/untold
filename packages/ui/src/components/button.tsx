...
const buttonVariants = cva(
  "group/button cn-font-heading inline-flex shrink-0 items-center justify-center rounded-md border border-transparent bg-clip-padding text-sm font-semibold whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-45 aria-invalid:border-destructive aria-invalid:ring-1 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          'border-border bg-transparent hover:bg-foreground/7 hover:text-foreground aria-expanded:bg-foreground/7 aria-expanded:text-foreground active:bg-foreground/14',
        secondary:
          'border-border bg-transparent hover:bg-foreground/7 active:bg-foreground/14',
        ghost:
          'text-primary border-transparent px-1 hover:bg-primary/10 active:bg-primary/18',
        destructive:
