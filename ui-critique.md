...
Ask for (or find) one of: a running URL (local dev server like `http://localhost:3001`, or a deployed URL), or screenshots + component source if no live URL exists.
